...
exhibitor_list_link = "https://www.security-essen.de/impulsgeber/ausstellerliste/"
...
def get_exhibitor_links():
    tools.scroll()
    filter_str = '/impulsgeber/ausstellerliste/detail'
    prefix = 'https://www.security-essen.de'
