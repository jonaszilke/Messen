...
exhibitor_list_link = "https://www.innotrans.de/de/besuchen/ausstellerverzeichnis/#/suche/f=h-entity_orga;v_sg=0;v_fg=0;v_fpa=FUTURE"
...
def open_all_exhibitors():
    if tools.run_mode == RunMode.RUN:
        while True:
            tools.scroll()
            show_more_css = '#onlineGuide > div > div.EWP5KKC-e-I > div:nth-child(2) > div:nth-child(2) > div.EWP5KKC-u-b > div.EWP5KKC-u-c > div'
            try:
...
if __name__ == "__main__":
    ...
    for i in range(1,30):
        ...
        while True:
            ...
            css_link = f'#onlineGuide > div > div.EWP5KKC-e-I > div:nth-child(2) > div:nth-child(2) > div.listContentContainer > div:nth-child({i}) > div.EWP5KKC-e-J > div:nth-child({j}) > div.EWP5KKC-w-l > div.EWP5KKC-w-w > div.EWP5KKC-d-h > div.gwt-Label.EWP5KKC-w-Q'
            try:
