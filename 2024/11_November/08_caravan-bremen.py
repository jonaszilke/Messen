...
exhibitor_list_link = "https://www.caravan-bremen.de/de/ausstellung/ausstellerliste/?letter=a"
...
def get_exhibitor_links():
    ...
    for letter in list(string.ascii_lowercase) + ['numbers', 'others']:
        ex_link = f'https://www.caravan-bremen.de/de/ausstellung/ausstellerliste/?letter={letter}'
        tools.open_link(ex_link)
        filter_str = '/aussteller/'
        prefix = 'https://www.caravan-bremen.de'
