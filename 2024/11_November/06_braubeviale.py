...
exhibitor_list_link = "https://www.braubeviale.com/de-DE/aussteller-und-produkte/"
...
if __name__ == "__main__":
    ...
    setup()
    with open('./data/06_braubeviale_numbers.txt', 'r') as f:
    ...
    while True:
        if i in finished:
            i += 1
            continue
        css_exhibitor = f'#profairs-widget-exhibitor > div > div.pf-widget.pf-exhibitor > div > div.pf-exhibitor-grid > div.pf-exhibitor-content > div > div > div.pf-exhibitor-events__list > div:nth-child({i})'
        ...
        try:
            ...
            time.sleep(1)
            counter = 0
            with open('./data/06_braubeviale_numbers.txt', 'a') as f:
                f.write(f'{i}\n')
