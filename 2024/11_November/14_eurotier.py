...
exhibitor_list_link = "https://digital.eurotier.com/newfront/marketplace/exhibitors?pageNumber=1&limit=60"
...
def get_exhibitor_links():
    ...
    for i in range(1, 192):
        page = f'https://digital.eurotier.com/newfront/marketplace/exhibitors?pageNumber={i}&limit=12'
        tools.open_link(page)
        time.sleep(2)
