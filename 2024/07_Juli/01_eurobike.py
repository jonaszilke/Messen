...
exhibitor_list_link = "https://eurobike.com/frankfurt/de/ausstellersuche.html"
...
def parse_exhibitor(ex: Exhibitor):
    ...
    ex.mail = tools.get_href_from_css_link(css_mail, timeout=0.5).replace('mailto:', '').replace('?subject=EUROBIKE%202024', '')
