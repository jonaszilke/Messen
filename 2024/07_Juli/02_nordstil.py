...
exhibitor_list_link = "https://nordstil.messefrankfurt.com/hamburg/de/ausstellersuche.html"
...
def get_exhibitor_links():
    ...
    filter_str = '/hamburg/de/ausstellersuche.detail.html'
    prefix = 'https://nordstil.messefrankfurt.com'
...
def parse_exhibitor(ex: Exhibitor):
    ...
    ex.mail = tools.get_href_from_css_link(css_mail, timeout=0.5).replace('mailto:', '').replace('?subject=Nordstil%20(Summer%20Edition)%202024', '')
