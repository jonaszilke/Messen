...
def parse_exhibitor(ex: Exhibitor):
    ...
    css_url = '#__next > div.MuiBox-root.css-g9qx4c > main > div > div > div > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.MuiGrid-grid-md-6.MuiGrid-grid-lg-4.css-obamm2 > div > div > div:nth-child(3) > div > div > div.MuiBox-root.css-19ambhl > a > h6'  # TODO
