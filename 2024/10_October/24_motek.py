...
exhibitor_list_link = "https://www.motek-messe.de/ausstellerverzeichnis/"
...
def accept_cookies():
    try:
        ...
        tools.click_css_link(css_accept, timeout=2)
...
if __name__ == "__main__":
    ...
    for page_num in range(1,5):
        ex_link = f'https://www.motek-messe.de/ausstellerverzeichnis/?pg={page_num}'
