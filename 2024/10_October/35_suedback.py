...
exhibitor_list_link = "https://www.messe-stuttgart.de/suedback/aussteller/ausstellerverzeichnis#/exhibitor"
...
def parse_exhibitor(ex: Exhibitor):
    css_info = 'div.ed-detail__segment.ed-detail__segment--contacts'
